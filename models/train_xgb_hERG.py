...
plt.legend()
plt.savefig('/mnt/d/outreachy-contributions-tracker/figures/hERG_xgb_roc_curve.png')
plt.close()
...
plt.savefig('/mnt/d/outreachy-contributions-tracker/figures/hERG_xgb_confusion_matrix.png')
plt.close()