...
xgb = XGBClassifier(n_estimators=200, learning_rate=0.05, max_depth=6, random_state=42, scale_pos_weight=1.8)
...
plt.legend()
plt.savefig('/mnt/d/outreachy-contributions-tracker/figures/hERG_tune2_xgb_roc_curve.png')
plt.close()
...
plt.savefig('/mnt/d/outreachy-contributions-tracker/figures/hERG_tune2_xgb_confusion_matrix.png')
plt.close()