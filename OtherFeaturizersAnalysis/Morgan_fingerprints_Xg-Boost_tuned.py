...
plt.title('ROC Curve - hERG XGBoost Tuned')
plt.legend()
plt.savefig('/mnt/d/outreachy-contributions-tracker/figures/hERG_Morgan_fingerprints_tune_xgb_roc_curve.png')
plt.close()
...
plt.ylabel('True')
plt.title('Confusion Matrix - hERG XGBoost Tuned')
plt.savefig('/mnt/d/outreachy-contributions-tracker/figures/hERG_Morgan_fingerprints_tune_xgb_confusion_matrix.png')
plt.close()