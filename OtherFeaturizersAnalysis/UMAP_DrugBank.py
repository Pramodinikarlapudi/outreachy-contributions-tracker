...
data = pd.read_csv("/mnt/d/outreachy-contributions-tracker/data/hERG_DrugBank.csv")
y = data['Label']
...
plt.xlabel('UMAP1')
plt.ylabel('UMAP2')
plt.title('hERG UMAP (eos9gg2 Features)')
plt.legend()
plt.savefig('/mnt/d/outreachy-contributions-tracker/figures/DrugBank_hERG_umap_labels.png')
plt.close()