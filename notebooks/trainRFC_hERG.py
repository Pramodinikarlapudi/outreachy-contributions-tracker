...
plt.legend()
plt.savefig('/mnt/d/outreachy-contributions-tracker/figures/hERG_roc_curve.png')
plt.close()
...
plt.savefig('/mnt/d/outreachy-contributions-tracker/figures/hERG_confusion_matrix.png')
plt.close()
